...
public interface IPartitionedTupleBufferManager {
    ...
    String profileBufferManager() throws HyracksDataException;

    void setDataInsertion(VPartitionTupleBufferManager.INSERTION dataInsertion, double[] insertionParams);
     ...
     * @throws HyracksDataException
     */
    void flushPartition(int pid, IFrameWriter writer, boolean flushToDisk) throws HyracksDataException;
